<?php
namespace Opencart\Catalog\Controller\Extension\Payeer\Payment;
class Payeer extends \Opencart\System\Engine\Controller
{
  public function index(): string
  {
		...
		$data['lang'] = preg_replace('/-(.+?)+/', '', $this->config->get('config_language'));
    ...
    $this->model_checkout_order->addHistory($data['m_orderid'], $this->config->get('payment_payeer_order_wait_id'), '', true);
		return $this->load->view('extension/payeer/payment/payeer', $data);
	}
      ...
      $this->load->language('extension/payeer/payment/payeer');
			...
			if (!$err) {
				...
				if (!$order) {
                  ...
                  $this->model_checkout_order->addHistory($request['m_orderid'], $this->config->get('payment_payeer_order_success_id'), '', true);
								}
								break;
                  ...
                  $this->model_checkout_order->addHistory($request['m_orderid'], $this->config->get('payment_payeer_order_fail_id'), '', true);
									$err = true;
								}
								break;
						}
